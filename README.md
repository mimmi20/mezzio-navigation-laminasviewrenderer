...
| `getRoles() : array`                                                                                 | Retrieve the current Authorization roles, if any.                                                         |
| `setRoles(array $roles) : self`                                                                      | Set Authorization roles.                                                                                  |
| `hasRoles() : bool`                                                                                  | Whether or not an Authorization role instance is present.                                                 |
